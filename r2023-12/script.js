...
// }
    ...
    searchBar.addEventListener('input', function(e) {
        ...
        if(isdpon1===1){
            addpre='';
            addpre ='Demand planning ';
            isdpon1=0;
        }
        else if(isspon1===1){
            addpre='';
            addpre='Supply Planning ';
            isspon1=0;
        }
        else if(isdion1===1){
            addpre='';
            addpre='Data Integration ';
            isdion1=0;
        }
        else if(isEKGon1===1){
            addpre='';
            addpre='EKG Configurator ';
            isEKGon1=0;
        }
        else if(iskhon1===1){
            addpre='';
            addpre='Knowledge Hub ';
            iskhon1=0;
        }
        else if(issson1===1){
            addpre='';
            addpre='Sustainability Solution ';
            issson1=0;
        }
        else if(ispson1===1){
            addpre='';
            addpre='Production Scheduling ';
            ispson1=0;
        }
        else if(isngpon1===1){
            addpre='';
            addpre='Next Generation ';
            isngpon1=0;
        }
        else if(isron1===1){
            addpre='';
